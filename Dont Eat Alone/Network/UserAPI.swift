...
extension API {
    ...
    static func createUser(email: String, password: String, first_name: String, last_name: String, major: String, minor: String, year: Int, self_bio: String, completion: @escaping () -> Void) {
    ...
    static func loginUser(username: String, password: String, grant_type: String, client_id: String, client_secret: String, completion: @escaping () -> Void) {
        USEREMAIL = username
   ...
   static func readUsers(email: String, access_token: String, completion: @escaping () -> Void) {
   ...
   static func updateUser(email: String, password: String, first_name: String, last_name: String, major: String, minor: String, year: Int, self_bio: String, access_token: String, completion: @escaping () -> Void) {
